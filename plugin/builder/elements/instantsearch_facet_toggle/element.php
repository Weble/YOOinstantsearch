...
$titleFields = [
    ...
    'title_element' => [
        ...
        'type' => 'select',
        'options' => ['h1' => 'h1', 'h2' => 'h2', 'h3' => 'h3', 'h4' => 'h4', 'h5' => 'h5', 'h6' => 'h6', 'div' => 'div'],
    ],
    'title_style' => [
        'label' => 'Style',
        'description' => 'Headline styles differ in font size and font family.',
        'type' => 'select',
        'options' => ['None' => '', '2X-Large' => 'heading-2xlarge', 'X-Large' => 'heading-xlarge', 'Large' => 'heading-large', 'Medium' => 'heading-medium', 'Small' => 'heading-small', 'H1' => 'h1', 'H2' => 'h2', 'H3' => 'h3', 'H4' => 'h4', 'H5' => 'h5', 'H6' => 'h6'],
    ],
    'title_decoration' => [
        'label' => 'Decoration',
        'description' => 'Decorate the headline with a divider, bullet or a line that is vertically centered to the heading.',
        'type' => 'select',
        'options' => ['None' => '', 'Divider' => 'divider', 'Bullet' => 'bullet', 'Line' => 'line'],
    ],
    'title_color' => [
        'label' => 'Color',
        ...
        'type' => 'select',
        'options' => ['None' => '', 'Muted' => 'muted', 'Emphasis' => 'emphasis', 'Primary' => 'primary', 'Secondary' => 'secondary', 'Success' => 'success', 'Warning' => 'warning', 'Danger' => 'danger', 'Background' => 'background'],
    ],
    'title_font_family' => [
        'label' => 'Font Family',
        'description' => 'Select an alternative font family.',
        'type' => 'select',
        'options' => ['None' => '', 'Default' => 'default', 'Primary' => 'primary', 'Secondary' => 'secondary', 'Tertiary' => 'tertiary'],
    ],
];
...
$fields = array_merge($titleFields, [
    'facet_name' => ['label' => 'Facet Name'],
    'facet' => ['label' => 'Facet'],
    'on_condition' => ['label' => 'On', 'attrs' => ['placeholder' => 'Facet value']],
    'off_condition' => ['label' => 'Off'],
    'facet_count' => ['label' => 'Facet count', 'text' => 'Show', 'type' => 'checkbox'],
...
return [
    'name' => 'instantsearch_facet_toggle',
    'title' => 'Toggle Filter',
        ...
        'default' => [
            ...
            'fields' => [
                [
                    'title' => 'Settings',
                    'fields' => [
                        ['label' => 'Toggle', 'type' => 'group', 'divider' => true, 'fields' => ['facet', 'title', 'facet_name', 'facet_count']],
                        ['label' => 'Conditions', 'description' => 'Define what value will be refined when the toggle is on and off.', 'type' => 'grid', 'width' => '1-2', 'fields' => ['on_condition', 'off_condition']],
                ...
                [
                    'title' => 'Title',
                    'fields' => [
                        ['label' => 'Title', 'type' => 'group', 'divider' => true, 'fields' => ['title', 'title_style', 'title_decoration', 'title_font_family', 'title_color', 'title_element']],
                    ],
                ],
                '${builder.advanced}',
            ],
